 ...
 *
 * @backport \Icinga\Module\Monitoring\Backend\Ido\Query\HostgroupQuery from Icinga Web 2.5.0
 * @ref 26032a0413e7f30af40a623da3751612f837ea55
 * @see https://github.com/Icinga/icingaweb2/issues/1883
 * @see https://github.com/Icinga/icingaweb2-module-toplevelview/issues/23
 */
class IcingaHostgroupQuery extends IdoQuery
{
    protected $allowCustomVars = true;

    protected $groupBase = array(
        'hostgroups'         => array('hgo.object_id', 'hg.hostgroup_id'),
        // disabled for fix 06cb980308f3c0d6c7807530576b0230016a15e2
